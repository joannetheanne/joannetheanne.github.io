...
function show(button_element) {
    ...
    */
    ...
    var info = document.getElementById("ta-fun-fact");
    var selected = button_element.id;
        // console.log(selected);
    var fact = facts[selected];
        // console.log(facts[selected]);
    info.innerHTML = fact;
...
function highlight(button_element){
    ...
    button_element.style = "color: black; background-color: yellow;";
    prev_btn = button_element;
}
